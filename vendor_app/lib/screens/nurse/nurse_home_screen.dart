...
/// Nurse home screen - Main dashboard for nurses
...
class _NurseHomeScreenState extends State<NurseHomeScreen> {
  ...
  Future<void> _loadDashboard() async {
    ...
    try {
      final stats = await _apiClient.nurse.getDashboard();
      setState(() {
        _stats = stats;
        _isAvailable = stats.isAvailable ?? true;
        _isLoading = false;
      });
    } catch (e) {
  ...
  Future<void> _toggleAvailability() async {
    try {
      await _apiClient.nurse.updateAvailability(!_isAvailable);
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    _isAvailable ? 'Available for Bookings' : 'Unavailable',
