...
/// Pathology bookings list screen
...
class _PathologyBookingsScreenState extends State<PathologyBookingsScreen> {
  ...
  Future<void> _loadBookings() async {
    ...
    try {
      final data = await _apiClient.admin.getPathologyBookings(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pathology Bookings'),
        ...
        actions: [
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              ...
              const PopupMenuItem(value: 'sample_collected', child: Text('Sample Collected')),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (booking['tests'] != null && (booking['tests'] as List).isNotEmpty) ...[
                const SizedBox(height: 8),
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(
                      '${(booking['tests'] as List).length} test(s)',
                      style: TextStyle(color: Colors.grey[600]),
                    ),
                  ],
                ),
